                            ...
                            for i in range(faces_found):
                                ...
                                if (bb[i][3]-bb[i][1])/frame.shape[0] > 0.25:
                                    ...
                                    if best_class_probabilities > 0.85:
                                        cv2.rectangle(frame, (bb[i][0], bb[i][1]), (bb[i][2], bb[i][3]), (0, 255, 255), 2)
                                        ...
                                        name = class_names[best_class_indices[0]]
                                        cv2.putText(frame, "Unknow", (text_x, text_y), cv2.FONT_HERSHEY_COMPLEX_SMALL,
...
def postData(name):
    ...
    url = "http://192.168.1.9:8000/api/time/add_time/" +str(name)+"?day=" + str(current_date)+"&time="+str(current_time)
    print("url = ",url)
